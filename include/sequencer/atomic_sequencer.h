...
class Atomic_sequencer : public Controllable_sequencer {
public:
  ...
  const Base_event_t* at(const size_type step_idx) const override;
  ...
  void toggle(Step_idx) override;
  void toggle_all() override;
